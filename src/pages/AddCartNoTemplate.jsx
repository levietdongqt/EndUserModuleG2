...
import {
  Box, Icon, Text, Heading, SimpleGrid, Button, Image, useToast
              ...
              <ThemeProvider>
                <Box
                  ...
                  <SimpleGrid columns={{ base: 4, sm: 4, lg: 4, xl: 4 }} spacing={3} >
                      ...
                      <SimpleGrid columns={{ base: 1, sm: 1, lg: 1, xl: 1 }} spacing={3} >
                        <FormControl>
                          ...
                          <Select
                            ...
                            onChange={(event) => { handlePrintSize(event.target.value, index) }}
                            required={true}
                          >
                            {item && item.printSizes.map((option, index2) => {
                              return (
                                <MenuItem key={index2} value={option.templateSizeID}>
                        ...
                        <FormControl>
                          ...
                          <Select
                            required={true}
                            onChange={(event) => { handleMaterialPage(event.target.value, index) }}
                          >
                    ...
                    <Box ml={20}>
                      <SimpleGrid columns={{ base: 1, sm: 1, lg: 1, xl: 1 }} spacing={3} >
                        <Text textAlign='left' mt={1} fontSize={24} color='facebook.500' fontWeight={300} >Amount: {amount[index]}</Text>
                        <Text textAlign='left' mt={1} fontSize={24} color='facebook.500' fontWeight={300} >Price: ${price[index]}</Text>
                        <Button
                          variant='solid'
